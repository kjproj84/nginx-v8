#define NGX_CONFIGURE " --with-debug --add-module=/home/kijin/nginx-1.14.0/cppngx --with-cc-opt='-Wno-deprecated -fomit-frame-pointer -pthread -Wno-unused -Wno-error -std=c++11 -fpermissive' --with-ld-opt='-lstdc++ -ldl -lpthread' --without-http_rewrite_module --without-http_fastcgi_module --without-http_scgi_module --without-http_proxy_module --without-http_split_clients_module --without-http_uwsgi_module --without-http_gzip_module"
